...
Both rootless and rootful packages are generated by default:
...
- rootless: installed under `/var/jb`
- rootful: installed under `/usr` and `/Library`
...
The iOS service always runs as root:
